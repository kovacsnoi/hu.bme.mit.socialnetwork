 ...
 * @generated
 */
public class SocialNetworkPackageSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SocialNetworkPackageSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SocialNetworkPackagePackage.SOCIAL_NETWORK: {
				SocialNetwork socialNetwork = (SocialNetwork)theEObject;
				T result = caseSocialNetwork(socialNetwork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SocialNetworkPackagePackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SocialNetworkPackagePackage.POST: {
				Post post = (Post)theEObject;
				T result = casePost(post);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SocialNetworkPackagePackage.ACTOR: {
			...
			case SocialNetworkPackagePackage.MOVIE: {
				Movie movie = (Movie)theEObject;
				T result = caseMovie(movie);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SocialNetworkPackagePackage.CHARACTER: {
				socialNetworkPackage.Character character = (socialNetworkPackage.Character)theEObject;
				T result = caseCharacter(character);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SocialNetworkPackagePackage.AWARD: {
				Award award = (Award)theEObject;
				T result = caseAward(award);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SocialNetworkPackagePackage.LIKE: {
	 ...
	 * @generated
	 */
	public T caseCharacter(socialNetworkPackage.Character object) {
		return null;
	}
